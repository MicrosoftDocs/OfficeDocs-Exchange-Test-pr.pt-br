...
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dn198286(v=EXCHG.150)
ms:contentKeyID: 54652048
ms.date: 08/29/2014
...
This topic contains the procedures that you can use as a reference when managing the Exchange Server 2013 Management Pack. For procedures related to deployment, see [Procedimentos Relacionados à Implantação](procedures-related-to-deployment.md).
...
![Desabilitando um alerta no console do SCOM](images/Dn198286.1c4f15b5-4978-4442-b26b-cc65ba577c9c(EXCHG.150).png "Desabilitando um alerta no console do SCOM")
...
See the following topics for more information about the cmdlets you can use to configure monitoring overrides.
  ...
  - [Get-MonitoringItemIdentity](https://technet.microsoft.com/pt-br/library/jj218668\(v=exchg.150\))
