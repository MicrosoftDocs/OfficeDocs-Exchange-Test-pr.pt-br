---
title: 'Função de gerenciamento de função: Exchange 2013 Help'
TOCTitle: Função de gerenciamento de função
ms:assetid: 71d8553c-150d-4306-8de0-89be6efb5e40
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876906(v=EXCHG.150)
ms:contentKeyID: 50485807
ms.date: 05/22/2018
...
A função de gerenciamento de `Role Management` permite que administradores gerenciem grupos de funções de gerenciamento; políticas de atribuição de função e funções de gerenciamento; e entradas de função, atribuições e escopos em uma organização.

Os usuários atribuídos a essa função podem substituir o grupo de funções gerenciado pela propriedade, configurar qualquer grupo de funções e adicionar ou remover membros de qualquer grupo de funções.
