---
title: 'Função de agentes de extensão de cmdlet: Exchange 2013 Help'
TOCTitle: Função de agentes de extensão de cmdlet
ms:assetid: 20f9f7c2-a8e5-468e-b1a8-c87c562a2be7
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876857(v=EXCHG.150)
ms:contentKeyID: 50485165
ms.date: 05/22/2018
