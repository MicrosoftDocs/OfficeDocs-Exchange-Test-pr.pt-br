---
title: 'Função de configurações de transporte da organização: Exchange 2013 Help'
TOCTitle: Função de configurações de transporte da organização
ms:assetid: ff4d032e-1b97-4a9d-b479-9b0d61832221
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876961(v=EXCHG.150)
ms:contentKeyID: 50487101
ms.date: 05/22/2018
...
A função de gerenciamento de `Organization Transport Settings` permite que administradores gerenciem configurações de transporte de toda a organização, como mensagens do sistema, a configuração de site do Active Directory e definições de configuração de transporte de toda a organização do Exchange.

Essa função não permite que você criar ou gerenciar envio ou recebimento conectores, filas, higienização, operadores, domínios remotos e aceitos ou regras. Para criar ou gerenciar cada um dos recursos de transporte, você deve ser atribuído um ou mais das seguintes funções:
