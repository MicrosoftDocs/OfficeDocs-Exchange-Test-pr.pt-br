---
title: 'Função de compartilhamento federada: Exchange 2013 Help'
TOCTitle: Função de compartilhamento federada
ms:assetid: 3d81048c-24bf-447d-a1ee-7fb2974a51fd
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876876(v=EXCHG.150)
ms:contentKeyID: 50485366
ms.date: 05/22/2018
...
A função de gerenciamento `Federated Sharing` permite aos administradores gerenciar o compartilhamento entre florestas e entre organizações em uma organização.
