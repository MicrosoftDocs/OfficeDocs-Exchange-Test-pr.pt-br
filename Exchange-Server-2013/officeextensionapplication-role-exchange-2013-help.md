---
title: 'Função OfficeExtensionApplication: Exchange 2013 Help'
TOCTitle: Função OfficeExtensionApplication
ms:assetid: a78f69b8-2403-40a0-8c86-7e0fb7b10d29
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ657479(v=EXCHG.150)
ms:contentKeyID: 50486347
ms.date: 05/22/2018
...
A função de gerenciamento de `OfficeExtensionApplication` permite que aplicativos de extensão do Microsoft Office acessem caixas de correio do usuário.
