---
title: 'Função MyVoiceMail: Exchange 2013 Help'
TOCTitle: Função MyVoiceMail
ms:assetid: 5c7310e9-742c-4bdf-90b6-0a0d17c3bda1
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876890(v=EXCHG.150)
ms:contentKeyID: 50485689
ms.date: 05/22/2018
...
A função de gerenciamento `MyVoiceMail` permite que usuários individuais exibam e modifiquem suas configurações de caixa postal.
