---
title: 'Função MyBaseOptions: Exchange 2013 Help'
TOCTitle: Função MyBaseOptions
ms:assetid: 77b4643b-f777-44b8-87a4-040f9843515a
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876910(v=EXCHG.150)
ms:contentKeyID: 50485839
ms.date: 05/22/2018
...
A função de gerenciamento `MyBaseOptions` permite que usuários individuais exibam e modifiquem a configuração básica de sua própria caixa de correio e as definições associadas.
