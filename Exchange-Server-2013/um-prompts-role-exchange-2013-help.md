---
title: 'Função de Prompts de UM: Exchange 2013 Help'
TOCTitle: Função de Prompts de UM
ms:assetid: 262928e8-b938-404f-b941-a636f4d18169
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876861(v=EXCHG.150)
ms:contentKeyID: 50485205
ms.date: 05/22/2018
...
A função de gerenciamento `UM Prompts` permite que os administradores criem e gerenciem prompts de voz personalizados da Unificação de Mensagens em uma organização.
