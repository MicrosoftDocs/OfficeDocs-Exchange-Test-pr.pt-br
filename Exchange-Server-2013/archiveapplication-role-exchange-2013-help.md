---
title: 'Função ArchiveApplication: Exchange 2013 Help'
TOCTitle: Função ArchiveApplication
ms:assetid: 22d673cf-d3a3-43f0-be1e-e4fc74546e64
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ673046(v=EXCHG.150)
ms:contentKeyID: 50485173
ms.date: 05/22/2018
...
A função de gerenciamento `ArchiveApplication` permite que aplicativos parceiros arquivem itens em caixas de correio de usuário.
