---
title: 'Função de diretivas de endereço de email: Exchange 2013 Help'
TOCTitle: Função de diretivas de endereço de email
ms:assetid: d272e672-81ea-417c-b5d6-76a5efd5c036
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876944(v=EXCHG.150)
ms:contentKeyID: 50486723
ms.date: 05/22/2018
...
A função de gerenciamento de `E-Mail Address Policies` permite que administradores gerenciem políticas de endereço de email em uma organização.
