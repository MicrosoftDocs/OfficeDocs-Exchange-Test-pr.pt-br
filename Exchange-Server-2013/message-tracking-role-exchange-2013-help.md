---
title: 'Função de controle de mensagem: Exchange 2013 Help'
TOCTitle: Função de controle de mensagem
ms:assetid: 21f18ccd-9b7d-461b-b77c-443d15696d79
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876858(v=EXCHG.150)
ms:contentKeyID: 50485111
ms.date: 05/22/2018
...
A função de gerenciamento de `Message Tracking` permite que administradores acompanhem as mensagens em uma organização.
