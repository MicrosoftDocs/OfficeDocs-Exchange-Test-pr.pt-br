---
title: 'Usando híbrida moderno autenticação com o Outlook para iOS e Android: Exchange 2013 Help'
TOCTitle: Usando híbrida moderno autenticação com o Outlook para iOS e Android
ms:assetid: 0e701643-1f18-4cc3-8595-4fd4b15caf6c
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Mt846639(v=EXCHG.150)
ms:contentKeyID: 74520296
ms.date: 04/23/2018
mtps_version: v=EXCHG.150
ms.translationtype: HT
---

# Usando híbrida moderno autenticação com o Outlook para iOS e Android

 

_**Aplica-se a:** Exchange Server 2013_

_**Tópico modificado em:** 2018-04-19_
...
![Diagrama arquitetônico de autenticação moderna híbrida no Outlook para iOS e Android](images/Mt846639.20a7e963-916d-47e0-bffb-4d86c4777bea(EXCHG.150).png "Diagrama arquitetônico de autenticação moderna híbrida no Outlook para iOS e Android")
...
![Fluxo de autenticação na autenticação moderna híbrida](images/Mt846639.d6e20ddb-cf8e-4154-8a17-95657ef696d1(EXCHG.150).png "Fluxo de autenticação na autenticação moderna híbrida")
...
![Um exemplo de uma conta do Outlook para iOS e Android configurada para autenticação moderna híbrida](images/Mt846639.79887a65-e5e1-4501-a274-008393dbb6c9(EXCHG.150).png "Um exemplo de uma conta do Outlook para iOS e Android configurada para autenticação moderna híbrida")
...
![As caixas de diálogo que os usuários deverão ver durante uma configuração bem-sucedida de Autenticação Moderna híbrida](images/Mt846639.2e17cce9-d4b7-4842-9c5a-d92f055dbf56(EXCHG.150).png "As caixas de diálogo que os usuários deverão ver durante uma configuração bem-sucedida de Autenticação Moderna híbrida")
...
![Uma caixa de diálogo indicando que um usuário está vendo a experiência do Exchange ActiveSync de autenticação Básica herdada](images/Mt846639.32bb9907-9cae-4200-9cbf-8091da2eac83(EXCHG.150).png "Uma caixa de diálogo indicando que um usuário está vendo a experiência do Exchange ActiveSync de autenticação Básica herdada")
...
![Uma caixa de diálogo que os usuários veem quando a detecção automática não consegue descobrir a configuração das suas caixas de correio locais](images/Mt846639.b481cab4-e5b0-4f52-b931-7c4e059453f1(EXCHG.150).png "Uma caixa de diálogo que os usuários veem quando a detecção automática não consegue descobrir a configuração das suas caixas de correio locais")
