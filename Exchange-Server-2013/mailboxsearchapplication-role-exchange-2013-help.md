---
title: 'Função MailboxSearchApplication: Exchange 2013 Help'
TOCTitle: Função MailboxSearchApplication
ms:assetid: 914b9132-e420-4b27-ab30-57f672166d24
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ657470(v=EXCHG.150)
ms:contentKeyID: 50486129
ms.date: 05/22/2018
...
A função de gerenciamento de `MailboxSearchApplication` permite que aplicativos de parceiros pesquisar caixas de correio.
