---
title: 'Função org personalizado Apps: Exchange 2013 Help'
TOCTitle: Função org personalizado Apps
ms:assetid: ab2aac13-f783-43e6-a369-75cce1d4943f
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ657482(v=EXCHG.150)
ms:contentKeyID: 50486341
ms.date: 05/22/2018
...
A função de gerenciamento de aplicativos personalizados do Org permite que administradores exibam e modifiquem os aplicativos de sua organização e para adicionar aplicativos personalizados de um arquivo ou uma URL.
