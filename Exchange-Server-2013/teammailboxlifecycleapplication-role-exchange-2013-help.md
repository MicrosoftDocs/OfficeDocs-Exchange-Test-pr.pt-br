---
title: 'Função TeamMailboxLifecycleApplication: Exchange 2013 Help'
TOCTitle: Função TeamMailboxLifecycleApplication
ms:assetid: 3cd2cd6f-65e1-4e66-a017-054060c46fe1
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ673057(v=EXCHG.150)
ms:contentKeyID: 50485360
ms.date: 05/22/2018
...
A função de gerenciamento `TeamMailboxLifecycleApplication` permite que aplicativos parceiros atualizem estados do ciclo de vida de caixa de correio de site.
