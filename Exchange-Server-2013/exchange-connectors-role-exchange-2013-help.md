---
title: 'Função de conectores do Exchange: Exchange 2013 Help'
TOCTitle: Função de conectores do Exchange
ms:assetid: 73f98c82-bde0-443d-9bcf-274047e84e15
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876908(v=EXCHG.150)
ms:contentKeyID: 50485931
ms.date: 05/22/2018
...
A função de gerenciamento do `Exchange Connectors` habilita os administradores a criar, modificar, exibir e remover conectores de agente de entrega.

Esta função não pode ser usada para gerenciar conectores de envio e recebimento. Para gerenciar conectores de envio e recebimento, use as funções Conectores de Envio e Conectores de Recebimento. Para obter mais informações, consulte:
