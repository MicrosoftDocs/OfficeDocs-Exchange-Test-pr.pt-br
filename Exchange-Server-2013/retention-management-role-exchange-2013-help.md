---
title: 'Função de gerenciamento de retenção: Exchange 2013 Help'
TOCTitle: Função de gerenciamento de retenção
ms:assetid: ef16b495-c424-4ded-b5da-304e69ce31bb
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876953(v=EXCHG.150)
ms:contentKeyID: 50486962
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Função de gerenciamento de retenção
...
A função de gerenciamento de `Retention Management` permite que administradores gerenciem políticas de retenção em uma organização.
