---
title: 'Função MyTeamMailboxes: Exchange 2013 Help'
TOCTitle: Função MyTeamMailboxes
ms:assetid: 269bf64a-5028-40e4-96ec-17c362a73e69
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ673048(v=EXCHG.150)
ms:contentKeyID: 50485157
ms.date: 05/22/2018
...
A função de gerenciamento `MyTeamMailboxes` permite que os usuários individuais criem caixas de correio de site e as conectem a sites do Microsoft SharePoint.
