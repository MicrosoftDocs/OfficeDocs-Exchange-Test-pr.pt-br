---
title: 'Função de acesso para cliente da organização: Exchange 2013 Help'
TOCTitle: Função de acesso para cliente da organização
ms:assetid: ff84799a-b79c-498d-b797-7675a4afb1eb
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876962(v=EXCHG.150)
ms:contentKeyID: 50487102
ms.date: 05/22/2018
...
A função de gerenciamento de `Organization Client Access` permite que administradores gerenciem configurações de servidor de acesso para cliente em uma organização.
