---
title: 'Função de Pastas Públicas: Exchange 2013 Help'
TOCTitle: Função de Pastas Públicas
ms:assetid: b858f04c-ac0b-495f-9193-8b9645781f73
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876930(v=EXCHG.150)
ms:contentKeyID: 50486472
ms.date: 05/22/2018
...
A função de gerenciamento de `Public Folders `permite que administradores gerenciem pastas públicas em uma organização.

Essa função não permite determinar se as pastas públicas são habilitados para email. Para habilitar email ou desabilitar uma pasta pública, você deve ser atribuído a uma função associada à função `Mail Enabled Public Folders `. Para obter mais informações, consulte [Função de pastas públicas habilitadas para email](mail-enabled-public-folders-role-exchange-2013-help.md).
