---
title: 'Remoto e a função de domínios aceitos: Exchange 2013 Help'
TOCTitle: Remoto e a função de domínios aceitos
ms:assetid: 340c7546-5236-4743-a2b3-3c2363f3da1d
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876869(v=EXCHG.150)
ms:contentKeyID: 50485304
ms.date: 05/22/2018
...
A função de gerenciamento `Remote and Accepted Domains` permite aos administradores gerenciar domínios remotos e aceitos em uma organização.
