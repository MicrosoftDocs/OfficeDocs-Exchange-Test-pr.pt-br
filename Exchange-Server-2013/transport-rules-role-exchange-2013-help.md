---
title: 'Função de regras de transporte: Exchange 2013 Help'
TOCTitle: Função de regras de transporte
ms:assetid: 53c5b1a5-e989-4373-ac70-7db16000c645
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876885(v=EXCHG.150)
ms:contentKeyID: 50485607
ms.date: 05/22/2018
...
A função de gerenciamento de `Transport Rules` permite que os administradores gerenciem as regras de transporte em uma organização.
