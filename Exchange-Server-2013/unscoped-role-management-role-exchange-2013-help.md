---
title: 'Função de gerenciamento de função sem escopo: Exchange 2013 Help'
TOCTitle: Função de gerenciamento de função sem escopo
ms:assetid: d11eb843-64c9-4968-bfd5-9a8d94903058
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876943(v=EXCHG.150)
ms:contentKeyID: 50486702
ms.date: 05/22/2018
...
A função de gerenciamento de `Unscoped Role Management` permite que os administradores criem e gerenciem funções de gerenciamento de nível superior sem escopo em uma organização.
