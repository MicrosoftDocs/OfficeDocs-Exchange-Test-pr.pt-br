---
title: 'Função de agentes de transporte: Exchange 2013 Help'
TOCTitle: Função de agentes de transporte
ms:assetid: 1679402e-158f-4630-8ef1-01ab5c7ce811
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876853(v=EXCHG.150)
ms:contentKeyID: 50485099
ms.date: 05/22/2018
...
A função de gerenciamento de `Transport Agents` permite que administradores gerenciem os agentes de transporte em uma organização.
