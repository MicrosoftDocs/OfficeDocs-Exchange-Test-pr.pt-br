---
title: 'Minha função ReadWriteMailbox Apps: Exchange 2013 Help'
TOCTitle: Minha função ReadWriteMailbox Apps
ms:assetid: febb73fb-3a0b-4c67-b53b-9566d7c32cd2
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Mt793556(v=EXCHG.150)
ms:contentKeyID: 74418137
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Minha função ReadWriteMailbox Apps
