---
title: 'Função de caixas de correio de Unificação de mensagens: Exchange 2013 Help'
TOCTitle: Função de caixas de correio de Unificação de mensagens
ms:assetid: 6c9442dc-e674-4474-888e-e2f391a8eb57
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876901(v=EXCHG.150)
ms:contentKeyID: 50485779
ms.date: 05/22/2018
