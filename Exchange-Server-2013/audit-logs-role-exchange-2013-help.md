---
title: 'Função de Logs de auditoria: Exchange 2013 Help'
TOCTitle: Função de Logs de auditoria
ms:assetid: 36a7d375-76f8-441c-9da1-8a50dbd062f1
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876870(v=EXCHG.150)
ms:contentKeyID: 50485334
ms.date: 05/22/2018
...
A função de gerenciamento `Audit Logs` permite aos administradores configurar o log de auditoria de administrador em uma organização.
