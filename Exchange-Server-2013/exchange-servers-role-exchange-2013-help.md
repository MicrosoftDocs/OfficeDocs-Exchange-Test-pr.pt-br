---
title: 'Função de servidores do Exchange: Exchange 2013 Help'
TOCTitle: Função de servidores do Exchange
ms:assetid: 5a626746-8d23-409c-a604-7e565c429990
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876887(v=EXCHG.150)
ms:contentKeyID: 50485673
ms.date: 05/22/2018
...
A função de gerenciamento de `Exchange Servers` permite aos administradores proceder da seguinte forma em servidores individuais:

  - Adicionar e remover grupos de disponibilidade de banco de dados e configurar cópias de banco de dados

  - Habilitar, desabilitar e configurar os serviços de Unificação de Mensagens

  - Modificar a configuração de transporte nos servidores de Caixa de Correio e Acesso para Cliente

  - Habilitar e desabilitar Microsoft Outlook Anywhere nos servidores de Acesso para Cliente

  - Modificar a configuração do servidor de Caixa de Correio e Acesso para Cliente

  - Modificar configuração do Outlook Anywhere em servidores de Acesso para Cliente

  - Modificar a configuração de filtragem de conteúdo em servidores de Caixa de Correio

  - Modificar configuração geral do serividor do Exchange

  - Modificar a configuração do servidor de monitoramento

  - Exibir a configuração para cada função de servidor
