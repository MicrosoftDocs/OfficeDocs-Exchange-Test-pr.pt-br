---
title: 'Função MyProfileInformation: Exchange 2013 Help'
TOCTitle: Função MyProfileInformation
ms:assetid: 309c3a88-8abe-497d-aa92-30bdc58b9eae
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876865(v=EXCHG.150)
ms:contentKeyID: 50485283
ms.date: 05/22/2018
...
A função de gerenciamento `MyProfileInformation` permite que usuários individuais modifiquem seus nomes.
