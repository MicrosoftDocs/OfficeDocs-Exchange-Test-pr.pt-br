---
title: 'Função de pesquisa de caixa de correio: Exchange 2013 Help'
TOCTitle: Função de pesquisa de caixa de correio
ms:assetid: f86b63ba-0c67-4748-8965-0c08a6a8aec1
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876958(v=EXCHG.150)
ms:contentKeyID: 50487027
ms.date: 05/22/2018
...
A função de gerenciamento de `Mailbox Search` permite que administradores pesquisem o conteúdo de uma ou mais caixas de correio em uma organização.
