---
title: 'Função de opções do usuário: Exchange 2013 Help'
TOCTitle: Função de opções do usuário
ms:assetid: fb4d58f5-cc62-4ce8-b2e4-c3cc91795a12
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876960(v=EXCHG.150)
ms:contentKeyID: 50487042
ms.date: 05/22/2018
...
A função de gerenciamento de `User Options` permite aos administradores exibir as opções de Outlook Web App de um usuário em uma organização. Esta função pode ser usada para ajudar a diagnosticar problemas de configuração.
