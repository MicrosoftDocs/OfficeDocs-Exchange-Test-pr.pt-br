---
title: 'Função de inscrições de borda: Exchange 2013 Help'
TOCTitle: Função de inscrições de borda
ms:assetid: 7de1a663-96fb-4fb5-898a-effa82653597
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876912(v=EXCHG.150)
ms:contentKeyID: 50486024
ms.date: 05/22/2018
