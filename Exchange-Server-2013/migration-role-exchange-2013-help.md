---
title: 'Função de migração: Exchange 2013 Help'
TOCTitle: Função de migração
ms:assetid: 8b5a3385-7dc0-4492-9f00-a4616982016b
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876920(v=EXCHG.150)
ms:contentKeyID: 50486118
ms.date: 05/22/2018
...
A função de gerenciamento de `Migration` permite que administradores migrem caixas de correio e de conteúdo de caixa de correio dentro ou fora de um servidor.
