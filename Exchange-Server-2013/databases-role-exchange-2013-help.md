---
title: 'Função de bancos de dados: Exchange 2013 Help'
TOCTitle: Função de bancos de dados
ms:assetid: 317d9945-668b-448e-963f-f7127b9b3d79
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876868(v=EXCHG.150)
ms:contentKeyID: 50485289
ms.date: 05/22/2018
...
The A função de gerenciamento `Databases` permite aos administradores criar, gerenciar, montar e desmontar bancos de dados de caixa de correio em servidores individuais.
...
O cmdlet **Move-DatabasePath**, incluído nesta função, exige que o banco de dados a ser configurado esteja dentro do escopo do banco de dados, e que tal banco de dados esteja em um servidor que está dentro do escopo do servidor.

Além disso, o cmdlet **Remove-MailboxDatabase**, que também está incluído nesta função, exige que o banco de dados a ser removido esteja dentro do escopo do banco de dados ou então que esse banco de dados esteja em um servidor que está dentro do escopo do servidor. Isso significa que você controla quem pode remover bancos de dados de caixa de correio usando escopos de servidor ou banco de dados.

Para mais informações, consulte [Noções básicas sobre escopos da função de gerenciamento](understanding-management-role-scopes-exchange-2013-help.md).
