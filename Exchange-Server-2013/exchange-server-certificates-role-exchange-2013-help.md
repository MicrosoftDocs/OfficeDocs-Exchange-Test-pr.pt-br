---
title: 'Função de certificados de servidor do Exchange: Exchange 2013 Help'
TOCTitle: Função de certificados de servidor do Exchange
ms:assetid: fffec840-6c7d-4958-905e-edc4bc060d52
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876963(v=EXCHG.150)
ms:contentKeyID: 50487097
ms.date: 05/22/2018
...
A função de gerenciamento de `Exchange Server Certificates` permite aos administradores criar, importar, exportar e gerenciar certificados de servidor Exchange em servidores individuais.
