---
title: 'Função MyContactInformation: Exchange 2013 Help'
TOCTitle: Função MyContactInformation
ms:assetid: 0df7fc20-d9b3-40db-bb14-ba8b903df201
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876850(v=EXCHG.150)
ms:contentKeyID: 50484940
ms.date: 05/22/2018
...
A função de gerenciamento `MyContactInformation` permite que usuários individuais modifiquem suas informações de contato, incluindo endereço e telefones.
