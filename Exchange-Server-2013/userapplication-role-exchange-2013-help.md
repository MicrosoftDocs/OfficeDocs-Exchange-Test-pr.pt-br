---
title: 'Função UserApplication: Exchange 2013 Help'
TOCTitle: Função UserApplication
ms:assetid: a4621e45-53db-42f7-a5d7-c1900a154b4e
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ657476(v=EXCHG.150)
ms:contentKeyID: 50486314
ms.date: 05/22/2018
...
A função de gerenciamento de `UserApplication` permite que aplicativos de parceiros ajam em nome de usuários finais.
