---
title: 'Função de configuração de somente leitura: Exchange 2013 Help'
TOCTitle: Função de configuração de somente leitura
ms:assetid: 72607063-7f2d-4b3e-a2a9-27eb88e1e16a
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876907(v=EXCHG.150)
ms:contentKeyID: 50485810
ms.date: 05/22/2018
...
Essa função pode ser combinada com as funções associadas a função `View-Only Recipients` para criar um grupo de função que possa exibir cada objeto em uma organização. Para obter mais informações, consulte [Função destinatários de somente leitura](view-only-recipients-role-exchange-2013-help.md).
