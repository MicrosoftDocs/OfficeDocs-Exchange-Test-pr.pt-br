---
title: 'Função de Logs de auditoria somente para exibição: Exchange 2013 Help'
TOCTitle: Função de Logs de auditoria somente para exibição
ms:assetid: 9298fe59-0a16-4a09-bdb8-514d1cea6e2f
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Ff461933(v=EXCHG.150)
ms:contentKeyID: 50486198
ms.date: 05/22/2018
...
A função de gerenciamento de `View-Only Audit Logs` permite que os administradores e usuários especialistas para pesquisar o administrador auditar logs em uma organização.
