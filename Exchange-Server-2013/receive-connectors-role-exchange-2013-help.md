---
title: 'Função de conectores de recebimento: Exchange 2013 Help'
TOCTitle: Função de conectores de recebimento
ms:assetid: a7c5a086-5066-4ece-9b22-cc1048d2f2bc
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876927(v=EXCHG.150)
ms:contentKeyID: 50486303
ms.date: 05/22/2018
...
A função de gerenciamento de `Receive Connectors` permite que administradores gerenciem a configuração do conector de recebimento, como os limites de tamanho em um servidor individual de transporte.
