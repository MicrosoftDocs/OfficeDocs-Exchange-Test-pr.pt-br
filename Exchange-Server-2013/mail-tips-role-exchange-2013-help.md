---
title: 'Função de dicas de email: Exchange 2013 Help'
TOCTitle: Função de dicas de email
ms:assetid: 74495ded-6097-4f10-a829-c8ed81f5ba3e
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876909(v=EXCHG.150)
ms:contentKeyID: 50485932
ms.date: 05/22/2018
...
A função de gerenciamento de dicas de email permite que administradores gerenciem dicas de email em uma organização.
