---
title: 'Função de configuração de organização: Exchange 2013 Help'
TOCTitle: Função de configuração de organização
ms:assetid: db952cc5-ef70-4366-acbb-0e292d4cbdd0
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876946(v=EXCHG.150)
ms:contentKeyID: 50486833
ms.date: 05/22/2018
...
A função de gerenciamento de `Organization Configuration` permite que administradores gerenciem configurações de toda a organização. A configuração da organização que pode ser controlada com esta função inclui o seguinte e mais:

  - Se MailTips estiverem habilitados ou desabilitados para a organização

  - URL da home page de pasta gerenciada

  - Microsoft Exchange endereço SMTP do destinatário e endereços de email alternativos

  - Configuração do esquema de propriedade de caixa de correio de recurso

  - URLs de ajuda para o Exchange Centro de administração e o Microsoft Office Outlook Web App

Esse tipo de função não incluir permissões incluídas em `Organization Client Access` ou `Organization Transport Settings` funções.
