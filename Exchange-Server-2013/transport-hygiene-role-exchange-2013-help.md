---
title: 'Função de higienização de transporte: Exchange 2013 Help'
TOCTitle: Função de higienização de transporte
ms:assetid: 629792e4-7a8f-4447-b031-1c7d7c994b8a
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876893(v=EXCHG.150)
ms:contentKeyID: 50485833
ms.date: 05/22/2018
...
A função de gerenciamento `Transport Hygiene` permite que os administradores gerenciem recursos antispam e antimalware em uma organização.
