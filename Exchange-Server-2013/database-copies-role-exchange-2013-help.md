---
title: 'Função de cópias de banco de dados: Exchange 2013 Help'
TOCTitle: Função de cópias de banco de dados
ms:assetid: 71a95f5b-1f75-4ae9-9ee9-515c3a19d394
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876905(v=EXCHG.150)
ms:contentKeyID: 50485803
ms.date: 05/22/2018
...
A função de gerenciamento de `Database Copies` permite aos administradores adicionar, remover, suspender, continuar, exibir e atualizar as cópias de banco de dados em servidores individuais.
...
Os cmdlets **Set-MailboxDatabaseCopy** e **Remove-MailboxDatabaseCopy** , que são incluídos com esta função, exigem que você deseja configurar ou remover o banco de dados deve estar dentro do escopo de banco de dados e o banco de dados deve residir em um servidor que está dentro do escopo de servidor. Para obter mais informações sobre escopos, consulte [Noções básicas sobre escopos da função de gerenciamento](understanding-management-role-scopes-exchange-2013-help.md).
