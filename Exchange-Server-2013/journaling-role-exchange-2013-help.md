---
title: 'Função de registro no diário: Exchange 2013 Help'
TOCTitle: Função de registro no diário
ms:assetid: 64608dbe-d4b4-444e-a7df-bc536c4da202
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876894(v=EXCHG.150)
ms:contentKeyID: 50485854
ms.date: 05/22/2018
...
A função de gerenciamento `Journaling` permite que os administradores criem, modifiquem, habilitem, desabilitem, exibam e removam regras do diário em uma organização.
