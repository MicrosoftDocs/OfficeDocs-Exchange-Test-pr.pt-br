---
title: 'Redefinir senha função: Exchange 2013 Help'
TOCTitle: Redefinir senha função
ms:assetid: d80101f1-7e3d-4a61-b93a-23da23e95e93
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ657499(v=EXCHG.150)
ms:contentKeyID: 50486791
ms.date: 05/22/2018
...
A função de gerenciamento de redefinir senha permite que usuários individuais redefinam suas próprias senhas e os administradores redefinam as senhas dos usuários em uma organização.
