---
title: 'Função de conectores de envio: Exchange 2013 Help'
TOCTitle: Função de conectores de envio
ms:assetid: 8021e279-2b74-469e-aa6d-d0197f34ba6c
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876913(v=EXCHG.150)
ms:contentKeyID: 50486003
ms.date: 05/22/2018
...
Conectores de envio do `Send Connectors` gerenciamento função permite que administradores gerenciem transporte em uma organização.
