---
title: 'Função MyDistributionGroups: Exchange 2013 Help'
TOCTitle: Função MyDistributionGroups
ms:assetid: 0d23dec0-3832-43bb-bc89-e01408acd0e8
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876849(v=EXCHG.150)
ms:contentKeyID: 50484997
ms.date: 05/22/2018
...
A função de gerenciamento `MyDistributionGroups` permite que usuários individuais criem, modifique e exibam grupos de distribuição, e que modifiquem, exibam, removam e adicionem membros a grupos de distribuição de sua propriedade.
