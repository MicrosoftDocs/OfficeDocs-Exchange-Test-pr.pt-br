---
title: 'Função de POP3 e IMAP4 protocolos: Exchange 2013 Help'
TOCTitle: Função de POP3 e IMAP4 protocolos
ms:assetid: 67dd66e0-3cca-4f87-8165-4918519b39b6
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876898(v=EXCHG.150)
ms:contentKeyID: 50485869
ms.date: 05/22/2018
...
A função de gerenciamento `POP3 and IMAP4 Protocols` permite que administradores gerenciem a configuração de POP3 e IMAP4, como definições de autenticação e conexão, em servidores individuais.
