---
title: 'Função de diretórios virtuais do Exchange: Exchange 2013 Help'
TOCTitle: Função de diretórios virtuais do Exchange
ms:assetid: d10896e9-3574-42bb-9090-61f3abc33005
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876942(v=EXCHG.150)
ms:contentKeyID: 50486700
ms.date: 05/22/2018
...
A função de gerenciamento de `Exchange Virtual Directories` permite que administradores gerenciem de Office de MicrosoftOutlook Web App, Microsoft ActiveSync, manuais de endereços offline (OABs), descoberta automática, Windows PowerShell e administração da Web interface diretórios virtuais em servidores individuais.
