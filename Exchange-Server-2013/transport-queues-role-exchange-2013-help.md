---
title: 'Função de filas de transporte: Exchange 2013 Help'
TOCTitle: Função de filas de transporte
ms:assetid: f663005a-4cb0-4c52-9c95-58681fc5eaab
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876955(v=EXCHG.150)
ms:contentKeyID: 50487013
ms.date: 05/22/2018
...
A função de gerenciamento de `Transport Queues` permite que administradores gerenciem filas de mensagens em um servidor de transporte individual.
