---
title: 'Função MyDiagnostics: Exchange 2013 Help'
TOCTitle: Função MyDiagnostics
ms:assetid: 62ba4bdd-6301-4daf-9368-3b393213ec1d
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd979793(v=EXCHG.150)
ms:contentKeyID: 50485738
ms.date: 05/22/2018
...
A função de gerenciamento `MyDiagnostics` permite que usuários individuais façam um diagnóstico básico de sua caixa de correio, como recuperar as informações de diagnóstico de calendário.
