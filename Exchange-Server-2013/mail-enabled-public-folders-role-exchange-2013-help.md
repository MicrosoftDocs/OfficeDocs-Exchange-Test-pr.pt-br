---
title: 'Função de pastas públicas habilitadas para email: Exchange 2013 Help'
TOCTitle: Função de pastas públicas habilitadas para email
ms:assetid: 22289ae1-f9e8-4c98-aaad-ee623e05eadd
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876859(v=EXCHG.150)
ms:contentKeyID: 50485112
ms.date: 05/22/2018
...
A função de gerenciamento `Mail Enabled Public Folders` permite aos administradores configurar se pastas públicas individuais serão habilitadas para email ou não em uma organização.

Essa função permite gerenciar apenas as propriedades de email de pastas públicas. Ela não permite gerenciar propriedades de pastas públicas que não estejam relacionadas ao email. Para gerenciar propriedades de pastas públicas que não estejam relacionadas ao email, use a função `Public Folders`. Para obter mais informações, consulte [Função de Pastas Públicas](public-folders-role-exchange-2013-help.md).
