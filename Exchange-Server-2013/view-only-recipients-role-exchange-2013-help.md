---
title: 'Função destinatários de somente leitura: Exchange 2013 Help'
TOCTitle: Função destinatários de somente leitura
ms:assetid: 37e66b92-81d3-412f-b7a9-e1bb8cbeb468
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Dd876872(v=EXCHG.150)
ms:contentKeyID: 50485375
ms.date: 05/22/2018
...
Essa função pode ser combinada com funções associadas à função `View-Only Configuration` para criar um grupo de função que possa exibir todos os objetos da organização. Para obter mais informações, consulte [Função de configuração de somente leitura](view-only-configuration-role-exchange-2013-help.md).
